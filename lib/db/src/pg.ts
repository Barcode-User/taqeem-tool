...
async function ensureTable(): Promise<void> {
  ...
  await pool.query(`
    CREATE TABLE IF NOT EXISTS reports (
      ...
      building_completion_percentage VARCHAR(50),
      building_type VARCHAR(100),
      finishing_status VARCHAR(100),
      furniture_status VARCHAR(100),
      air_conditioning_type VARCHAR(100),
      is_land_rented VARCHAR(10),
      additional_features TEXT,
      is_best_use VARCHAR(10),
  ...
  const newCols = [
    ...
    "ALTER TABLE reports ADD COLUMN IF NOT EXISTS building_completion_percentage VARCHAR(50)",
    "ALTER TABLE reports ADD COLUMN IF NOT EXISTS building_type VARCHAR(100)",
    "ALTER TABLE reports ADD COLUMN IF NOT EXISTS finishing_status VARCHAR(100)",
    "ALTER TABLE reports ADD COLUMN IF NOT EXISTS furniture_status VARCHAR(100)",
    "ALTER TABLE reports ADD COLUMN IF NOT EXISTS air_conditioning_type VARCHAR(100)",
    "ALTER TABLE reports ADD COLUMN IF NOT EXISTS is_land_rented VARCHAR(10)",
    "ALTER TABLE reports ADD COLUMN IF NOT EXISTS additional_features TEXT",
    "ALTER TABLE reports ADD COLUMN IF NOT EXISTS is_best_use VARCHAR(10)",
    "ALTER TABLE reports ADD COLUMN IF NOT EXISTS facades_count INTEGER",
    "ALTER TABLE reports ADD COLUMN IF NOT EXISTS valuers_input TEXT",
...
const FIELD_MAP_PG: Record<string, string> = {
  ...
  buildingAge: "building_age", buildingCompletionPercentage: "building_completion_percentage",
  buildingType: "building_type", finishingStatus: "finishing_status",
  furnitureStatus: "furniture_status", airConditioningType: "air_conditioning_type",
  isLandRented: "is_land_rented", additionalFeatures: "additional_features",
  isBestUse: "is_best_use",
  landArea: "land_area", buildingArea: "building_area",
  basementArea: "basement_area", annexArea: "annex_area",
  floorsCount: "floors_count", permittedFloorsCount: "permitted_floors_count",
  permittedBuildingRatio: "permitted_building_ratio",
  facadesCount: "facades_count", streetWidth: "street_width",
  streetFacades: "street_facades", utilities: "utilities", coordinates: "coordinates",
  latitude: "latitude", longitude: "longitude",
  valuersInput: "valuers_input",
  marketApproachPercentage: "market_approach_percentage",
  incomeApproachPercentage: "income_approach_percentage",
  costApproachPercentage: "cost_approach_percentage",
