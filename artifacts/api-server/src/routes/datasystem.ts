...
const FIELDS_SCHEMA = `{
  ...
  "streetWidth": "عرض الشارع (رقم فقط بالمتر — ابحث عن: عرض الشارع: X / بعرض X م / الشارع بعرض X / عرض X م — القيمة قد تكون مدمجة داخل وصف الشارع مثل: شارع الملك بعرض 20 م)",
...
• streetWidth (عرض الشارع): القيمة قد تكون مدمجة داخل وصف الشارع بصيغة "بعرض XX م" — مثال: "شارع أحمد بعرض 14 م" → streetWidth = 14 — استخرج الرقم فقط بدون وحدة`;
