...
const FIELDS_SCHEMA = `{
  ...
  "city": "المدينة (استخرج الاسم الكامل للمدينة حتى لو مدمج في العنوان — مثال: الرياض / جدة / مكة المكرمة / المدينة المنورة / الدمام / الطائف — احتفظ بالاسم الكامل ولا تختصره)",
  "district": "الحي",
  "street": "الشارع",
  ...
  "streetWidth": "عرض الشارع (رقم فقط بالمتر — ابحث عن العرض المرتبط بكلمة «شارع» تحديداً: شارع عرض X / شارع بعرض X / الشارع بعرض X / عرض الشارع X — تجاهل أي عرض مرتبط بـ«ارتداد» أو «ارتدادات» أو «الارتداد» — مثال: «ارتدادات عرض 11 م ثم شارع عرض 20 م» → 20)",
...
• city (المدينة): قد تكون مدمجة في العنوان مثل "حي الملز - الرياض" أو "مدينة جدة" — استخرج الاسم الكامل للمدينة ("المدينة المنورة" وليس "المدينة"، "مكة المكرمة" وليس "مكة") — لا تختصر الاسم أبداً
...
• streetWidth (عرض الشارع): استخرج العرض المرتبط بكلمة «شارع» فقط — تجاهل تماماً أي عرض مرتبط بـ«ارتداد/ارتدادات» — أمثلة: "شارع بعرض 20 م" → 20 | "ارتدادات عرض 11 م ثم شارع عرض 20 م" → 20 | "شارع عرض 15 م" → 15 — استخرج الرقم فقط بدون وحدة`;
...
function extractFields(body: Record<string, any>, filePath: string) {
  ...
  return {
    ...
    marketWay:                  s(body.marketWay),
    incomeWay:                  s(body.incomeWay),
    costWay:                    s(body.costWay),
