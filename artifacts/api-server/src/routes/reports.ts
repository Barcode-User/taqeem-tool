...
const FIELDS_SCHEMA = `{
  ...
  "buildingType": "نوع المبنى (مثال: فيلا، شقة، تجاري، مكاتب...)",
  "finishingStatus": "حالة التشطيب (مثال: كامل، جزئي، بدون تشطيب)",
  "furnitureStatus": "حالة التأثيث (مثال: مؤثث، غير مؤثث)",
  "airConditioningType": "نظام التكييف (مثال: مركزي، سبليت، بدون)",
  "isLandRented": "هل الأرض تحت المبنى مستأجرة؟ (نعم أو لا)",
  "additionalFeatures": "الميزات الإضافية للعقار مفصولة بفاصلة (مثال: مسبح، مواقف، نادي رياضي)",
  "isBestUse": "هل الاستخدام الحالي هو أفضل استخدام للعقار؟ (نعم أو لا)",
